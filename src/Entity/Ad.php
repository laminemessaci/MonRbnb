 ...
 * @UniqueEntity(
 *     fields={"title"},
 *     message="Une autre annoce possède dejâ ce titre !"
 * )
 */
class Ad
{
     ...
     * @Assert\Length(min=10, max=255, minMessage="Le titre doit faire plus de 10 caractères !", maxMessage="Le titre ne doit pas dépassé 255 caractères !")
     */
    private $title;
     ...
     * @Assert\Length(min=25, minMessage="Votre introduction doit faire plus de 20 caractères !")
     */
